...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <br><br>
                <h3><span class="link link-primary"><a href="archives.php">Voir archives ventes</a></span></h3>
                ...
                $fieldNameArray = ['ID Journal', 'Article', 'Quantité', 'PU', 'Description', 'PT', '<a href="../produit/addProduit.php">Retour</a>'];
